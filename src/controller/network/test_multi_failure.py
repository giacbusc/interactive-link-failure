...
def test_multi_failure():
    ...
    passed = (loss_initial == 0.0 and loss_first_fail == 0.0 and 
              loss_isolated == 100.0 and loss_frag == 0.0 and loss_final == 0.0)
    ...
    if passed:
        ...
        print("\n\033[91m=========================================\033[0m")
        print(f"\033[91m      FAIL (Initial: {loss_initial}%, Fail1: {loss_first_fail}%, Iso: {loss_isolated}%, Frag: {loss_frag}%, Final: {loss_final}%) \033[0m")
