...
def test_graph_restoration_logic():
    ...
    info("*** Waiting 5 seconds for LLDP discovery to fully register the recovered link...\n")
    time.sleep(5)
    ...
    if passed:
        ...
        print("\n\033[91m=========================================\033[0m")
        print(f"\033[91m      FAIL (Init: {loss_init}%, Backup: {loss_backup}%, Restored: {loss_restored}%) \033[0m")
