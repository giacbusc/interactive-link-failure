...
def test_partition():
    ...
    net.addLink(h3, s3); net.addLink(s3, s4); net.addLink(s4, h4)
    ...
    passed = (loss_i1 == 0.0 and loss_i2 == 0.0 and loss_cross == 100.0 and loss_final == 0.0)
    if passed:
        print("\n\033[92m=========================================\033[0m")
        ...
        print("\n\033[91m=========================================\033[0m")
        print(f"\033[91m      FAIL (I1: {loss_i1}%, I2: {loss_i2}%, Cross: {loss_cross}%, Final: {loss_final}%) \033[0m")
