...
def test_k4_mesh_storm_resilience():
    ...
    hosts = [net.addHost(f"h{i}", ip=f"10.0.0.{i}", mac=f"00:00:00:00:00:0{i}") for i in range(1, 5)]
    ...
    info("*** 2. Slicing graph: taking down s1-s2 and s3-s4 (forcing drastically new ST)\n")
    ...
    if passed:
        ...
        print("\n\033[91m=========================================\033[0m")
        print(f"\033[91m      FAIL (Full Mesh: {loss_full}%, Sliced: {loss_sliced}%) \033[0m")
